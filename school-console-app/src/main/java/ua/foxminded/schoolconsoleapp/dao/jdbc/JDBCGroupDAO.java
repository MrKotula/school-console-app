...
public class JDBCGroupDAO extends AbstractJdbcDAO<Group> implements GroupDAO {
    ...
    @Override
    public void insertSave(PreparedStatement statement, Group entity) throws SQLException {
	statement.setString(1, entity.getGroupName());
    }

    @Override
    public void insertUpdate(PreparedStatement statement, Group entity) throws SQLException {
	statement.setString(1, entity.getGroupName());
