...
public class JDBCStudentDAO extends AbstractJdbcDAO<Student> implements StudentDAO {
	...
	try (Connection connection = connectionProvider.getConnection();
	    ...
	    throw new DAOException(String.format(MESSAGE_EXCEPTION_DELETE_STUDENT_COURSE, studentId, courseId), e);
	}
    }

    @Override
    public List<Student> getStudentsWithCourseName(String courseName) throws DAOException {
    ...
    @Override
    public void insertSave(PreparedStatement statement, Student entity) throws SQLException {
    ...
    @Override
    public void insertUpdate(PreparedStatement statement, Student entity) throws SQLException {
	statement.setInt(1, entity.getGroupId());
	statement.setString(2, entity.getFirstName());
	statement.setString(3, entity.getLastName());
